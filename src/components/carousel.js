          ...
          <div>
            ...
            {/* The Carousel */}
                ...
                <Car 
                    ...
                    <div className="slider-text-container" id="aristotle" >
                        <h1 className="slider-text"  onClick={() => this.setPopup("Aristotle")}>Aristotle</h1>
                    </div>  
                    <div className="slider-text-container" id="locke">
                        <h1 className="slider-text" onClick={() => this.setPopup("Locke")}>Locke</h1>
                    </div>  
                    <div className="slider-text-container" id="nietzsche">
                        <h1 className="slider-text"  onClick={() => this.setPopup("Nietzsche")}>Nietzsche</h1>
                    </div> 
                    <div className="slider-text-container" id="kierkegaard">
                        <h1 className="slider-text" onClick={() => this.setPopup("Kierkegaard")}>Kierkegaard</h1>
                    </div> 
                    <div className="slider-text-container" id="hobbes">
                        <h1 className="slider-text" onClick={() => this.setPopup("Hobbes")}>Hobbes</h1>
                    </div> 
